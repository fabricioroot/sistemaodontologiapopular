 ...
 */
public class EncerrarAtendimentoTratamentoAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        // Captura na sessao o registro atendimentoTratamento
        ...
        try {
            ...
            System.out.println("Falha ao capturar registro de atendimentoTratamento da sessao em EncerrarAtendimentoTratamentoAction. Erro: " + e.getMessage());
            return mapping.findForward(FALHAIDENTIFICARATENDIMENTO);
        }

        // Captura o id do paciente que vem da pagina atenderAtendimentoTratamento.jsp
        String idPaciente = "";
        ...
        // Marca flag filaTratamento do paciente como false
        paciente.setFilaTratamento(Boolean.FALSE);
        if (PacienteService.atualizar(paciente)) {
            System.out.println("Registro de Paciente atualizado com sucesso em EncerrarAtendimentoTratamentoAction");
        }
        else {
        ...
        try {
            ...
            if (!funcionario.getCargo().equals("Dentista-Orcamento") || !funcionario.getCargo().equals("Dentista-Tratamento") || !funcionario.getCargo().equals("Dentista-Orcamento-Tratamento")) {
                System.out.println("Falha ao tentar identificar FuncionarioLogado, pois ele NAO eh Dentista. Falha mapeada em EncerrarAtendimentoTratamentoAction. Erro: " + e.getMessage() );
                return mapping.findForward(FUNCIONARIONAOEHDENTISTA);
            }
            else {
                System.out.println("Falha ao tentar identificar funcionarioLogado em EncerrarAtendimentoTratamentoAction. Erro: " + e.getMessage() );
        ...
        // Coloca na "fila de tratamentos finalizados"
        ...
        // Atualiza registro de atendimentoTratamento no banco
        if (!AtendimentoTratamentoService.atualizar(atendimentoTratamento)) {
            System.out.println("Falha ao atualizar registro de atendimentoTratamento de ID: " + atendimentoTratamento.getId() + " para encerrar o atendimento.");
            return mapping.findForward(FALHAATUALIZAR);
        }

        // Remove objetos relacionados ao atendimento da sessao
        // -- atendimentoTratamento, colocado na sessao por AtenderAtendimentoTratamentoAction ou ContinuarAtendimentoTratamentoAction
        request.getSession(false).removeAttribute("atendimentoTratamento");
        // -- Dentes, colocados na sessao por AtenderAtendimentoTratamentoAction ou ContinuarAtendimentoTratamentoAction
        ...
        // idPaciente, colocado na sessao por AtenderAtendimentoTratamentoAction ou ContinarAtendimentoTratamentoAction
