 ...
 */
public class AtenderAtendimentoTratamentoAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (ficha == null) {
            System.out.println("Registro de Ficha do paciente de ID: " + idPaciente + " NAO encontrado em AtenderAtendimentoTratamentoAction");
        ...
        if (FichaService.atualizar(ficha)) {
            System.out.println("Registro de Ficha (ID = " + ficha.getId() + ") atualizado com sucesso em AtenderAtendimentoTratamentoAction");
        }
        else {
            System.out.println("Falha ao atualizar registro de Ficha (ID = " + ficha.getId() + ") em AtenderAtendimentoTratamentoAction");
            return mapping.findForward(FALHAATUALIZAR);
        }

        // Busca registro de atendimentoTratamento associado a ficha do paciente
        ...
        if (atendimentoTratamento == null) {
            System.out.println("Registro AtendimentoTratamento NAO encontrado em AtenderAtendimentoTratamentoAction");
        ...
        try {
            ...
            if (/*!funcionario.getCargo().equals("Dentista-Orcamento") ||*/ !funcionario.getCargo().equals("Dentista-Tratamento") || !funcionario.getCargo().equals("Dentista-Orcamento-Tratamento")) {
                System.out.println("Falha ao tentar identificar FuncionarioLogado, pois ele NAO eh Dentista. Falha mapeada em AtenderAtendimentoTratamentoAction. Erro: " + e.getMessage() );
                return mapping.findForward(FUNCIONARIONAOEHDENTISTA);
            }
            else {
                System.out.println("Falha ao tentar identificar funcionarioLogado em AtenderAtendimentoTratamentoAction. Erro: " + e.getMessage() );
                return mapping.findForward(FALHAIDENTIFICARUSUARIOLOGADO);
            }
        }

        // Remove o registro de  atendimentoTratamento da fila de atendimento de tratamentos, inserindo-o
        // na fila de atendimento de tratamentos EM ATENDIMENTO e marca a data de inicio...
        atendimentoTratamento.setFilaAtendimentoTratamento(FilaAtendimentoTratamentoService.getFilaAtendimentoTratamentoEmAtendimento());
        atendimentoTratamento.setDataInicio(new Date());

        // Coloca o registro de atendimento de tratamento na sessao...
        ...
        try {
            ...
            System.out.println("Falha ao colocar registro de atendimentoTratamento na sessao em AtenderAtendimentoTratamentoAction! Erro: " + e.getMessage());
            return mapping.findForward(FALHAATUALIZAR);
        }
        if (AtendimentoTratamentoService.atualizar(atendimentoTratamento)) {
            System.out.println("Registro de AtendimentoTratamento atualizado com sucesso em AtenderAtendimentoTratamentoAction");
            ...
            System.out.println("Falha ao atualizar registro de AtendimentoTratamento em AtenderAtendimentoTratamentoAction");
            return mapping.findForward(FALHAATUALIZAR);
        }
    }
}