 ...
 */
public class ConsultarFilaAtendimentoTratamentoAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        // Busca atendimentos de tratamento que estao na fila e cria objeto (Collection<AtendimentoTratamento>)
        Collection<AtendimentoTratamento> atendimentoTratamentoCollection = AtendimentoTratamentoService.getAtendimentosFilaAtendimentoTratamento();
        if (atendimentoTratamentoCollection == null) {
            System.out.println("Registros de atendimentos de tratamentos NAO encontrados em ConsultarFilaAtendimentoTratamentoAction");
