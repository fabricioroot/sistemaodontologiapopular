 ...
 */
public class VisualizarChequeBancarioAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        // Captura o id do cheque bancario que vem da pagina consultar cheque bancario
        ...
        try {
            if (!idChequeBancario.trim().equals("")) {
            ...
            System.out.println("Falha ao consultar dados de cheque bancario no banco! Exception: " + e.getMessage());
