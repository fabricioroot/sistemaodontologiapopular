 ...
 */
public class ConsultarFilaAtendimentoOrcamentoAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        // Busca atendimentos de orcamentos que estao na fila e cria objeto (Collection<AtendimentoOrcamento>)
        Collection<AtendimentoOrcamento> atendimentoOrcamentoCollection = AtendimentoOrcamentoService.getAtendimentosFilaAtendimentoOrcamento();
        if (atendimentoOrcamentoCollection == null) {
            System.out.println("Registros de atendimentos de orcamentos NAO encontrados em ConsultarFilaAtendimentoOrcamentoAction");
