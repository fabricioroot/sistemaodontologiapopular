<%-- 
    Document   : visualizarHistoricoDenteParaLiberarProcedimentos
    Created on : 21/05/2010, 00:07:37
...
<html>
    ...
    <body onload="javascript:goFocus('voltar')">
        ...
        <%
            ...
            // Este objeto vem do action VisualizarHistoricoDenteAction acionado por botao da pagina liberarProcedimentos
        ...
        <table cellpadding="1" cellspacing="1" align="center" width="100%">
            ...
            <tr>
                <td align="center" colspan="4">
                    <table cellpadding="1" cellspacing="1" align="center" width="80%" style="border:none">
                        <tr>
                            <td align="center" style="border:none" colspan="4">
                        ...
                        %>
                        <tr>
                            <td bgcolor="#EBE9E9" align="center" style="border:none" colspan="4">
                        ...
                        <tr>
                            ...
                            <%
                                ...
                                String idBoca = dente.getBoca().getId().toString();
                                pageContext.setAttribute("idBoca", idBoca);
                                if (orcado) {
                            %>
                            <td style="border:none" align="center" valign="middle">
                                <input name="liberarProcedimentoDente" class="botaodefault" type="button" value="liberar" title="Liberar procedimento" onclick="javascript: if (confirm('Tem certeza que deseja LIBERAR este procedimento?')) location.href='<%=request.getContextPath()%>/app/caixa/liberarProcedimentoDente.do?idHistoricoDente=${idHistoricoDente}&idBoca=${idBoca}'" onMouseOver="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-med-over.png)'" onMouseOut="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-med.png)'">
                            </td>
                            <%
                                } // if (orcado)
                                else
                            ...
                            %>
                            <td style="border:none" align="center" valign="middle">
                                <input name="cancelarLiberacaoProcedimentoDente" class="botaodefaultextrag" type="button" value="cancelar libera&ccedil;&atilde;o" title="Cancelar libera&ccedil;&atilde;o" onclick="javascript: if (confirm('Tem certeza que deseja CANCELAR esta libera&ccedil;&atilde;o de procedimento?')) location.href='<%=request.getContextPath()%>/app/caixa/cancelarLiberacaoProcedimentoDente.do?idHistoricoDente=${idHistoricoDente}&idBoca=${idBoca}'" onMouseOver="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-extrag-over.png)'" onMouseOut="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-extrag.png)'">
                            </td>
                            <%
                                } // if (liberado)
                            %>
                            ...
                            <%
                                    ...
                                    out.println("<tr><td align='center' colspan='4' style='border:none'><p style='font-size:medium; font-style:italic; color:red;'>Hist&oacute;rico vazio...</p></td></tr>");
                                }
                            %>
                        <tr>
            ...
            <tr>
                <%
                    String idPaciente = dente.getBoca().getPaciente().getId().toString();
