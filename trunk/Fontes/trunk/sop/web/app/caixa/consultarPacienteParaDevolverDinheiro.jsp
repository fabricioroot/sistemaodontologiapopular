<%-- 
    Document   : consultarPacienteParaDevolucaoDinheiro
    Created on : 09/06/2010, 21:32:01
...
<html>
    ...
    <body onload="goFocus('nome')">
        ...
        <%
            ...
            request.getSession(false).setAttribute("proximaPagina",  request.getContextPath() + "/app/caixa/registrarDevolucaoDinheiro.do");
        %>
        <form name="formPaciente" id="formPaciente" method="POST" action="<%=request.getContextPath()%>/app/caixa/actionConsultarPacienteParaDevolverDinheiro.do">
            <table cellpadding="0" cellspacing="0" align="center" width="80%">
                <thead>
                    <tr>
                        <th colspan="2">Consulta de Pacientes para Devolver Dinheiro </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                            ...
                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                ...
                                <tr bgcolor="<%if (impedido) out.print("#ffcccc");%>" onMouseOver="javascript:this.style.backgroundColor='<% if (impedido) out.print("#ff9999"); else out.print("#B0FFAE");%>'" onMouseOut="javascript:this.style.backgroundColor=''">
                                    ...
                                    <td align="center">
                                        ...
                                        %>
                                        <a href="<%=request.getContextPath()%>/app/caixa/actionListarPagamentos.do?idPaciente=${idPaciente}"><img src="<%=request.getContextPath()%>/imagens/dinheiro.png" alt="Devolver" title="Registrar devolu&ccedil;&atilde;o de dinheiro"/></a>
