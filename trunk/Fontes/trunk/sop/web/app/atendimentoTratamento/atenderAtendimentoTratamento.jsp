<%--
    Document   : atenderAtendimentoTratamento
...
<html>
    <head>
        ...
        <title>Atendimento Tratamento - SOP - Sistema de Odontologia Popular</title>
    </head>
    <body>
        <jsp:include page="/app/cabecalho.jsp" flush="true">
            <jsp:param name="titulo" value="Atendimento Tratamento"/>
        </jsp:include>
        <br> &nbsp;
        <br> &nbsp;
        ...
        <%
            ...
            // Este objeto vem de AtenderAtendimentoTratamentoAction
       ...
       %>
        ...
        <table cellpadding="1" cellspacing="1" align="center" width="100%">
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                        ...
                        <tr>
                            ...
                            <%
                                if (dente != null) {
                            %>
                            <input name="manipularProcedimentos" class="botaodefaultpeq" type="button" value="+" title="Manipular procedimentos" onclick="javascript:location.href='<%=request.getContextPath()%>/app/atendimentoTratamento/manipularProcedimentos.do?idBoca=${idBoca}&idDente=<%=denteId%>'" onMouseOver="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-peq-over.png)'" onMouseOut="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-peq.png)'">
                            <%
                                }
                            %>
                            <br>
            ...
            <tr>
                ...
                <td class="paddingCelulaTabela" align="center" style="border:none">
                    <input name="encerrarAtendimento" class="botaodefaultextrag" type="button" value="encerrar atendimento" title="Encerrar atendimento" onclick="javascript: if (confirmarAcao('encerrar')) location.href='<%=request.getContextPath()%>/app/atendimentoTratamento/encerrarAtendimentoTratamento.do?idPaciente=${idPaciente}'" onMouseOver="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-extrag-over.png)'" onMouseOut="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-extrag.png)'">
                </td>
                <td style="border:none">
                    &nbsp;
                </td>
