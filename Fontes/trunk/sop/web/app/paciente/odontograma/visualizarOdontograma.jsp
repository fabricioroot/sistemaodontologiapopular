<%--
    Document   : visualizarOdontrograma
...
<html>
    ...
    <body onload="javascript:goFocus('voltar')">
        <jsp:include page="/app/cabecalho.jsp" flush="true">
            <jsp:param name="titulo" value="Odontograma"/>
        </jsp:include>
        <br> &nbsp;
        <br> &nbsp;
        ...
        <%
            ...
            // Este objeto vem de uma das seguintes paginas: consultarPaciente / consultarFilaAtendimentoOrcamento
            // ou consultarFilaAtendimentoTratamento quando clicado o botao visualizar odontograma
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                        ...
                        <tr>
                            <%
                                ...
                                String nome = "";
                                for (int i = 8; i >= 1; i--) {
                                    dente = (Dente)request.getAttribute("dente1" + String.valueOf(i));
                                    switch (i) {
                                        case 1: {
                            ...
                            <td align="center">
                                <%
                                    if (dente != null) {
                                %>
                                <input name="historico" class="botaodefaultpeq" type="button" value="+" title="Ver hist&oacute;rico" onclick="javascript:location.href='<%=request.getContextPath()%>/app/paciente/odontograma/actionVisualizarHistoricoDente.do?idBoca=${idBoca}&idDente=<%=denteId%>'" onMouseOver="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-peq-over.png)'" onMouseOut="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-peq.png)'">
                                <%
                                    }
                                %>
                                <br>
                        ...
                        <tr>
                            <%
                                dente = null;
                                for (int i = 1; i <= 8; i++) {
                                dente = (Dente)request.getAttribute("dente2" + String.valueOf(i));
                                switch (i) {
                                    case 1: {
                                        nome = "Incisivo Central";
                                    } break;
                        ...
                        <tr>
                            <%  
                                dente = null;
                                for (int i = 1; i <= 8; i++) {
                                dente = (Dente)request.getAttribute("dente3" + String.valueOf(i));
                                switch (i) {
                                    case 1: {
                                        nome = "Incisivo Central";
                                    } break;
                        ...
                        <tr>
                            <%  
                                dente = null;
                                for (int i = 8; i >= 1; i--) {
                                dente = (Dente)request.getAttribute("dente4" + String.valueOf(i));
                                switch (i) {
                                    case 1: {
                                        nome = "Incisivo Central";
                                    } break;
