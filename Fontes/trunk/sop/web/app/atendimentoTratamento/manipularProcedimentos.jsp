<%--
    Document   : manipularProcedimentos
...
<script type="text/javascript" language="javascript">
    <%@include file="atendimentoTratamento.js"%>
...
<html>
    <head>
        ...
        <title>Manipular Procedimentos / Parte do Dente ou Dente Inteiro - SOP - Sistema de Odontologia Popular</title>
    </head>
    <body onload="goFocus('procedimentoId')">
        <jsp:include page="/app/cabecalho.jsp" flush="true">
            <jsp:param name="titulo" value="Manipular Procedimentos / Parte do Dente ou Dente Inteiro"/>
        </jsp:include>
        <br> &nbsp;
        <br> &nbsp;
        ...
        <%
            ...
            // Este objeto vem do action VisualizarHistoricoDenteAction acionado por botao da pagina atenderAtendimentoTratamento
        ...
        <table cellpadding="1" cellspacing="1" align="center" width="100%">
                ...
                <td align="center" colspan="4" style="border:none">
                    <table cellpadding="1" cellspacing="1" align="center" width="80%" style="border:none">
                        ...
                        <tr>
                            ...
                            %>
                            <td align="left" colspan="<% if(orcado || liberado || emTratamento) out.print("1"); else out.print("2"); %>" style="border:none">
                            ...
                            <%
                                if (orcado || liberado || emTratamento) {
                            ...
                            <td style="border:none" align="center" valign="middle">
                                <%
                                    if (orcado) {
                                %>
                                    <input name="excluirRegistroHistoricoDente" class="botaodefault" type="button" value="excluir" title="Excluir" onclick="javascript: if (confirm('Tem certeza que deseja EXCLUIR este registro?')) location.href='<%=request.getContextPath()%>/app/atendimentoTratamento/excluirRegistroHistoricoDente.do?idHistoricoDente=${idHistoricoDente}'" onMouseOver="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-med-over.png)'" onMouseOut="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-med.png)'">
                                <%
                                    } // if (orcado)
                                    else
                                    if (liberado) {
                                %>
                                    <input name="iniciarProcedimento" class="botaodefaultextrag" type="button" value="iniciar procedimento" title="Iniciar" onclick="javascript: if (confirm('Tem certeza que deseja INICIAR este procedimento?')) location.href='<%=request.getContextPath()%>/app/atendimentoTratamento/iniciarProcedimento.do?idHistoricoDente=${idHistoricoDente}'" onMouseOver="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-extrag-over.png)'" onMouseOut="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-extrag.png)'">
                                <%
                                    } // if (liberado)
                                    else
                                    if (emTratamento) {
                                %>
                                    <input name="finalizarProcedimento" class="botaodefaultextrag" type="button" value="finalizar procedimento" title="Finalizar" onclick="javascript: if (confirm('Tem certeza que deseja FINALIZAR este procedimento?')) location.href='<%=request.getContextPath()%>/app/atendimentoTratamento/finalizarProcedimento.do?idHistoricoDente=${idHistoricoDente}'" onMouseOver="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-extrag-over.png)'" onMouseOut="javascript:this.style.background='url(<%=request.getContextPath()%>/imagens/bgbt-extrag.png)'">
                                <%
                                    } // if (emTratamento)
                                %>
                            </td>
            ...
            <tr>
                <td colspan="4">
                    <form name="formIncluirProcedimento" id="formIncluirProcedimento" method="POST" onsubmit="return validarDados()" action="<%=request.getContextPath()%>/app/atendimentoTratamento/actionIncluirProcedimento.do">
