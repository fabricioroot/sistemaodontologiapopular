<%--
    Document   : consultarPacienteParaLiberarProcedimentos
...
<html>
    <head>
        ...
        <title>Caixa - Pacientes - SOP - Sistema de Odontologia Popular</title>
    </head>
    <body onload="goFocus('nome')">
        ...
        <%
            ...
            request.getSession(false).setAttribute("proximaPagina", request.getContextPath() + "/app/caixa/liberacaoProcedimentos.do");
        %>
        <form name="formPaciente" id="formPaciente" method="POST" action="<%=request.getContextPath()%>/app/caixa/actionConsultarPacienteParaLiberacaoProcedimentos.do">
            <table cellpadding="0" cellspacing="0" align="center" width="80%">
                <thead>
                    <tr>
                        <th colspan="2">Consulta de Pacientes para Liberar ou Cancelar Libera&ccedil;&atilde;o de Procedimento(s)</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td colspan="2">
                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                ...
                                <tr bgcolor="<%if (impedido) out.print("#ffcccc");%>" onMouseOver="javascript:this.style.backgroundColor='<% if (impedido) out.print("#ff9999"); else out.print("#B0FFAE");%>'" onMouseOut="javascript:this.style.backgroundColor=''">
                                    ...
                                    <td align="center">
                                        <%  if (((Paciente) resultado.get(i)).getImpedimento().isEmpty()) { out.print("Nenhum");} else { out.print(((Paciente) resultado.get(i)).getImpedimento()); } %>
                                    </td>
                                    <td align="center">
                                        <%
                                    ...
                                    <td align="center">
                                        ...
                                        %>
                                        <a href="<%=request.getContextPath()%>/app/caixa/actionLiberacaoProcedimentos.do?idPaciente=${idPaciente}"><img src="<%=request.getContextPath()%>/imagens/dente.png" alt="Liberar Procedimentos" title="Manipular libera&ccedil;&atilde;o de procedimentos"/></a>
