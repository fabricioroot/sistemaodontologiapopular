 ...
 */
public class CancelarLiberacaoProcedimentoBocaCompletaAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (boca == null) {
            System.out.println("Registro de Boca (ID = " + idBoca + ") NAO encontrado em CancelarLiberacaoProcedimentoBocaCompletaAction");
        ...
        if (ficha == null) {
            System.out.println("Registro de Ficha do paciente (ID = " + boca.getPaciente().getId() + ") NAO encontrado em CancelarLiberacaoProcedimentoBocaCompletaAction");
            return mapping.findForward(FALHACONSULTAR);
        }
        ...
        if (historicoBoca == null) {
            System.out.println("Registro de HistoricoBoca (ID = " + idHistoricoBoca + ") NAO encontrado em CancelarLiberacaoProcedimentoBocaCompletaAction");
            return mapping.findForward(FALHACONSULTAR);
        }
        ...
        if (!historicoBoca.getStatusProcedimento().equals(StatusProcedimentoService.getStatusProcedimentoPago())) {
            ...
            if (FichaService.atualizar(ficha)) {
                System.out.println("Registro de Ficha (ID = " + ficha.getId() + ") atualizado com sucesso em CancelarLiberacaoProcedimentoBocaCompletaAction");
            }
            else {
                System.out.println("Falha ao atualizar registro de Ficha (ID = " + ficha.getId() + ") em CancelarLiberacaoProcedimentoBocaCompletaAction");
            ...
            if (!HistoricoBocaService.atualizar(historicoBoca)) {
                System.out.println("Falha ao atualizar registro de historicoBoca (ID = " + idHistoricoBoca + ") em CancelarLiberacaoProcedimentoBocaCompletaAction");
                return mapping.findForward(FALHAATUALIZAR);
            }
            else {
