 ...
 */
public class VisualizarFormaPagamentoAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        // Captura o id da forma de pagamento que vem da pagina consultar forma pagamento
        ...
        if (request.getAttribute("idFormaPagamento") != null) {
            idFormaPagamento = (String)request.getAttribute("idFormaPagamento");
        }
