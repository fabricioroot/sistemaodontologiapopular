...
public class IncluirProcedimentoAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            System.out.println("Falha ao capturar registro de atendimentoOrcamento da sessao em IncluirProcedimentoAction. Erro: " + e.getMessage());
            return mapping.findForward(FALHAIDENTIFICARATENDIMENTO);
        }
        historicoDente.setDentista(atendimentoOrcamento.getDentista());
        historicoDente.setProcedimento(new Procedimento(formIncluirProcedimento.getProcedimentoId()));
        historicoDente.setAtendimentoOrcamento(atendimentoOrcamento);
        historicoDente.setAtendimentoTratamento(AtendimentoTratamentoService.getAtendimentoTratamentoSistema());
        ...
        try {
            ...
            System.out.println("Falha ao capturar registro de dente da sessao em IncluirProcedimentoAction. Erro: " + e.getMessage());
        ...
        if(DenteService.salvarOuAtualizar(dente)) {
            System.out.println("Registro de Dente salvo/atualizado com sucesso em IncluirProcedimentoAction");
            return mapping.findForward(SUCESSO);
        }
        else {
            System.out.println("Falha ao salvar/atualizar registro de Dente em IncluirProcedimentoAction");
